...
//! [`color`], [`stats`], [`util`], and the layout maths rather than each
//! carrying a copy — a file has to be the same colour in both, and
//! duplicated colour tables were how it stopped being.
//!
